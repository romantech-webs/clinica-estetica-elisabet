  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="clinica-estetica-elisabet";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Clínica Estética ELISABET"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="clinica-estetica-elisabet"
          data-primary-color="#5b6339"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="clinica-estetica-elisabet";
